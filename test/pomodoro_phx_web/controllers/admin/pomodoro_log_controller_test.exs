defmodule PomodoroPhxWeb.Admin.PomodoroLogControllerTest do
  ...
  @create_attrs %{
    started_at: ~N[2024-08-20 12:24:00],
    finished_at: ~N[2024-08-20 12:24:00],
    rest_started_at: ~N[2024-08-20 12:24:00],
    rest_finished_at: ~N[2024-08-20 12:24:00],
    total_seconds: 42
  }
  @update_attrs %{
    started_at: ~N[2024-08-21 12:24:00],
    finished_at: ~N[2024-08-21 12:24:00],
    rest_started_at: ~N[2024-08-21 12:24:00],
    rest_finished_at: ~N[2024-08-21 12:24:00],
    total_seconds: 43
  }
  @invalid_attrs %{
    started_at: nil,
